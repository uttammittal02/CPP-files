...
// ----------------------------------------------------------------------------------------------------------- //
// ----------------------------------------------------------------------------------------------------------- //
int ans_(int n, bool carry){
    if(carry) return 9 - n;
    return n + 1; 
}

int numb_of_comb(string &s, int idx, bool carry){
    int n = sz(s);
    if (idx >= n) {
        if (carry) return 0;
        return 1;
    ...
    if (carry) curr--;
    int ans(0);
    if (idx + 2 < n) ans+= ans_(curr, true) * numb_of_comb(s, idx+2, true);

    ans += ans_(curr, false) * numb_of_comb(s, idx+2, false);
...
int32_t main(){
	...
	test_cases_loop{
        ...
        reverse(all(s));
        int ans = numb_of_comb(s, 0, false) * numb_of_comb(s, 1, false) - 2;
        cout<<ans<<endl;
