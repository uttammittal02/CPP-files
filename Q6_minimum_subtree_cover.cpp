...
int32_t main(){
    ...
    test_cases_loop{
        ...
        while((sz(tree[curr]) == 1 And curr==1) Or (sz(tree[curr])==2)){headroom++; tree[curr][0] != child_parent[curr] ? curr = tree[curr][0]: curr = tree[curr][1];}
        ...
        // cout << another_potential_answer << endl;
    }
    return 0;
}
