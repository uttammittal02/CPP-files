...
int32_t main(){
    ...
    while(left <= right){
        ...
        // for every r from 1 to n both inclusive check if prefix min array has an index l such that the above condiiton is satisfied or not 
